                                  ...
                                  <v-card-subtitle class="pb-0">Lugar: {{item.Lugar}}</v-card-subtitle></b>
                                    ...
                                    <v-card-text class="text--primary">
                                      ...
                                      <v-card-text class="text--primary">
                                        ...
                                        <v-card-subtitle color="white"class="pb-0">0=NO REVISADO, 1= APROBADO, 2= NO APROBADO
                                        </v-card-subtitle></b>
                                        <v-card-subtitle color="white"class="pb-0">Estado: {{item.Estado}}
                                        </v-card-subtitle></b>
                                        <v-card-subtitle color="white"class="pb-0">0=NO REVISADO, 1= PUBLICADO, 2 = DESPUBLICADO
                                        </v-card-subtitle></b>
